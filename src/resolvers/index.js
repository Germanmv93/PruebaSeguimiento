...
// Trae los objetos de Assets para el campo "Espacios en Jira" (customfield_10258)
resolver.define('getEspacios', async () => {
  ...
  if (!response.ok) {
    // Fallback: buscar sin filtro de tipo si el nombre del tipo es diferente
...
resolver.define('createIssue', async ({ payload }) => {
  ...
  // Campo Assets "Espacios en Jira" — requiere el objectKey del objeto
